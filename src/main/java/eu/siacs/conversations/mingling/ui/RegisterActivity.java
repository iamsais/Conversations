...
//        binding.password.setTransformationMethod(new HiddenPassTransformationMethod());
    ...
    private void onRegister() {
        ...
        if (TextUtils.isEmpty(name)) {
            binding.name.setError("Mandatory");
        ...
        if (binding.username.getError() == null && binding.password.getError() == null) {
            showLoader();
            registerCallApi(name, username, password);
        }
    }
...
//            binding.name.setText(account.getDisplayName());
    ...
    private void registerCallApi(String name, String username, String password) {
        Log.d(TAG, "registerCallApi");
        ...
        Call<GeneralResponse> call = loginApi.register(userRequest);
    ...
    private void showLoader() {
        runOnUiThread(() -> binding.loader.progressFrameLayout.setVisibility(View.VISIBLE));
    }

    private void hideLoader() {
        runOnUiThread(() -> binding.loader.progressFrameLayout.setVisibility(View.GONE));
    }
}
