...
public final class Config {
    ...
    public static final Jid BUG_REPORTS = Jid.of("bugs@cherrypickk.com");
    public static final Uri HELP = Uri.parse("https://help.cherrypickk.com");


    public static final String DOMAIN_LOCK = null; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "cherrypickk.com";
